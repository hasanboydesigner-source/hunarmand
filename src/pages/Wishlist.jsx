      ...
      <div className="container" style={{ paddingTop: '40px', paddingBottom: '64px' }}>
        ...
        {items.length === 0 ? (
          <div className="empty-wishlist" style={{
            ...
            padding: '80px 20px', textAlign: 'center', gap: '16px', background: 'var(--bg-secondary)',
            borderRadius: 'var(--radius-lg)', border: '1px dashed var(--border-medium)'
          }}>
            <Heart size={60} strokeWidth={1.5} opacity={0.2} style={{ color: 'var(--error)' }} />
